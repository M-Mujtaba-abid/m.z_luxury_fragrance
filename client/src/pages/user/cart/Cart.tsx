...
const Cart = () => {
  ...
  const { cartItems, total, error, updateQuantity, removeItem, clearCart } = useCart();
            ...
            <div className="bg-luxury-card border border-luxury-gold/10 rounded-lg shadow-md p-6 sticky top-4">
              ...
              <div className="space-y-3 mb-6 text-sm sm:text-base">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-luxury-gold">Rs. {total}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between text-lg font-bold">
                  ...
                  <span className="text-luxury-gold">Rs. {total}</span>
                </div>
              </div>
