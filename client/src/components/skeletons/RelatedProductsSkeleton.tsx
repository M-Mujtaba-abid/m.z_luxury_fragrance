const RelatedProductsSkeleton = () => {
    return (
        <div className="mt-16">
            <div className="h-8 w-64 rounded bg-luxury-card animate-pulse mb-8" />
                ...
                {[...Array(4)].map((_, index) => (
                    ...
                    >
                        ...
                        <div className="p-4 space-y-3">
                            ...
                            <div className="h-3 w-3/4 rounded bg-luxury-card/70" />
                            <div className="h-5 w-24 rounded bg-luxury-card/70" />
